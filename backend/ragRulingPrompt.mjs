...
export function buildRagRulingPromptBundle({
  ...
  let prompt = [
    ...
    "资料来源必须区分：official_direct_qa、official_related_qa、faq_related、card_text、baige_card_text、user_provided_text、raw_related。",
    ...
    "如果没有官方直接 Q&A，允许根据卡片文本、百鸽卡片资料、用户提供文本、FAQ、官方相似案例和基础 OCG 处理原则进行分析。",
    ...
    "不得把 card_text、baige_card_text、user_provided_text、related evidence、FAQ 或 rawRelatedEvidence 伪装成 official direct。",

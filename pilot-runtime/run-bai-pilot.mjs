...
function validateInput(input) {
  ...
  requireFact(qCells.length === 1 && fCells.length === 1 && input.cells.every(cell => (cell.questionId === "B04" && cell.group === "Q") || (cell.questionId === "B09" && cell.group === "F")), 'invalid_f_q_group_counts');

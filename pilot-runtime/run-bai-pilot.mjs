...
function validateInput(input) {
  ...
  requireFact(Array.isArray(input.cells) && [89, 90].includes(input.cells.length), 'cell_count_outside_89_to_90');
  ...
  requireFact(qCells.length === 45 && [44, 45].includes(fCells.length), 'invalid_f_q_group_counts');

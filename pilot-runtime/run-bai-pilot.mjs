...
function validateInput(input) {
  ...
  requireFact(Array.isArray(input.cells) && input.cells.length === 1, 'cell_count_outside_89_to_90');
  ...
  requireFact(qCells.length === 0 && fCells.length === 1 && input.cells.every(cell => cell.questionId === "B49"), 'invalid_f_q_group_counts');

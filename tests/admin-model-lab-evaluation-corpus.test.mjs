...
test("admin model lab corpus keeps the five mechanism regressions complete and resolvable", async () => {
  ...
  assert.equal(new Set(corpus.cases.map((item) => item.id)).size, 5);
